...
const create_live_class_dto_1 = require("./dto/create-live-class.dto");
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number, create_live_class_dto_1.CreateLiveClassDto,
        user_entity_1.User]),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], LiveClassesController.prototype, "list", null);
exports.LiveClassesController = LiveClassesController = __decorate([
    (0, swagger_1.ApiTags)('Live Classes'),
    ...
    (0, common_1.Controller)('courses/:courseId/live-classes'),
