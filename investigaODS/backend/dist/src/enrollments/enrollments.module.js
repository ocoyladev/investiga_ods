...
exports.EnrollmentsModule = EnrollmentsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([enrollment_entity_1.Enrollment]), courses_module_1.CoursesModule, subscriptions_module_1.SubscriptionsModule],
        providers: [enrollments_service_1.EnrollmentsService, roles_guard_1.RolesGuard],
